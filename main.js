...
////////////////////////////////////////////////////////////////////////////////
  ...
  function showPopOver(surveyNumber) {
    ...
    document.getElementById("edit_instructor").addEventListener('blur',validateName.bind(null,
  ...
  function inputAlpha(e) {
    ...
    e.returnValue = regex.test(key) || ( functionalKeys.indexOf(Number(e.keyCode)) >= 0 );
  ...
  function validateName(name) {
    ...
    if (name.match(/^[A-Z]{2,}([ ]?[,&\-]?[ ]?[A-Z]+)*$/)) {
      ...
      messageList.appendChild(err_message);
